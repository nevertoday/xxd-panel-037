...
Create fresh PNG artwork with `references/037-source.md` as the **sole creative and aesthetic authority**. This Skill is a runtime shell: it resolves delivery variables, appends them to the untouched source brief, executes bitmap generation, and verifies the result. It must not write a second art direction.
...
```text
[VERBATIM CONTENT OF references/037-source.md]
