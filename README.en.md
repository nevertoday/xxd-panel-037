...
Complete aesthetic constraints and rejection rules live in the Skill and production prompts. They preserve the original brief without turning its historical 3:4 canvas into a hidden default. [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-037-prompt.en.md)
...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 037 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 037 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 037 design fills the canvas; source remains invisible |
...
Project-specific copy rule: Use one very short place, subject, theme, or travel-emotion title in the target language. Curve it along the rim, inset it as enamel, cross a negative shape, or make it a metal nameplate; add at most two grounded micro-elements.
...
Full specifications: [Skill workflow](SKILL.md) · [source archive](references/037-source.md) · [English prompt](references/xxd-panel-037-prompt.en.md) · [Chinese prompt](references/xxd-panel-037-prompt.zh-CN.md)
...
<div align="center"><strong>A place becomes collectible when its defining contour survives the shine.</strong></div>
