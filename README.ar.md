...
لهذا الإحباط صنعت **Panel 037**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **تحويل كل رحلة إلى شارة مينا مذهّبة قابلة للاقتناء**.
