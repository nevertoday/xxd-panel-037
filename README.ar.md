...
### تحويل كل رحلة إلى شارة مينا مذهّبة قابلة للاقتناء
...
> شارة واحدة · مينا من المصدر · إطار معدني أبيض · تفصيل مذهّب · ظل حقيقي قصير

يُضغط المحيط الحاسم والسمات الموضعية في شارة سفر مادية واحدة: خلايا مينا من المصدر، وفواصل معدنية، وإطار من معدن أبيض، وتفاصيل مذهّبة محدودة، وسماكة مدوّرة، وظل حقيقي قصير.
...
- **الارتباط بالمصدر:** تحويل كل رحلة إلى شارة مينا مذهّبة قابلة للاقتناء
- **بصمة الأسلوب:** شارة واحدة · مينا من المصدر · إطار معدني أبيض · تفصيل مذهّب · ظل حقيقي قصير
...
توجد القيود الجمالية وقواعد الرفض الكاملة في المهارة وتوجيهات الإنتاج. وهي تحفظ دافع النص الأصلي من دون تحويل لوحة 3:4 التاريخية إلى قيمة افتراضية خفية. [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-037-prompt.en.md)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090799598336168140"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 037 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090799598336168140"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 037 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090799598336168140"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 037 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090799598336168140"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 037 نموذج 4"></a></td>
  </tr>
</table>

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2090799598336168140">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج الدافع الجمالي للإصدار 037 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع للتوليد أو إعدادات افتراضية حالية.
...
| --- | --- | --- |
| `top-bottom` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء في الأعلى وتصميم 037 في الأسفل، نحو 50/50 |
| `left-right` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء يساراً وتصميم 037 يميناً، نحو 50/50 |
| `design-only` | لوحة نهائية أكدها المستخدم | يملأ تصميم 037 اللوحة ولا تظهر صورة المصدر |
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-037`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/037-source.md) · [توجيه الإنتاج الإنجليزي](references/xxd-panel-037-prompt.en.md) · [توجيه الإنتاج الصيني](references/xxd-panel-037-prompt.zh-CN.md)
...
<div align="center" dir="rtl"><strong>تصبح الرحلة قابلة للاقتناء حين يبقى محيطها المميّز داخل اللمعان.</strong></div>
